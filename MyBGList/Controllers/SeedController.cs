...
namespace MyBGList.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        private readonly RoleManager<IdentityRole> _roleManager; // chapter 9 
        ...
        public async Task<IActionResult> BoardGameData()
        {
            ...
            /*5.6.1 CREATE exercise */
            //[HttpPut(Name = "Seed")]
            //[ResponseCache(NoStore = true)]
            //public async Task<IActionResult> Put(int? id = null) // in Put() method add parameter that will accept an optional Id parameter of integer type
            ...
            //            || string.IsNullOrEmpty(record.Name)
            //            || existingBoardGames.ContainsKey(record.ID.Value)
            //            || (id.HasValue && id.Value != record.ID.Value)) // 5.6.1 exercise
            //        {
            //            skippedRows++;
            //            continue;
            //        }
